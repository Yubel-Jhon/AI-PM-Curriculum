...
| 文档名称 | 版本 | 链接/位置 | 说明 |
| --- | --- | --- | --- |
| BRD：微信场景叫车渗透率分析 | v0.1 | [案例-BRD-微信AI打车助手.md](案例-BRD-微信AI打车助手.md) | 业务价值论证（值不值得做） |
| MRD：微信AI打车助手目标用户分析 | v0.1 | [案例-MRD-微信AI打车助手.md](案例-MRD-微信AI打车助手.md) | 目标用户画像（给谁做） |
| MCP 协议规范 | [TODO] | [TODO: 官方文档链接] | MCP Server 实现依据 |
| 打车平台 API 文档 | [TODO] | [TODO: 平台方提供] | MCP Server 封装依据 |
| FSD：微信AI打车助手功能规格 | v0.1 | [案例-FSD-微信AI打车助手.md](案例-FSD-微信AI打车助手.md) | Agent编排+MCP接口+数据模型+部署方案 |
